<div class="box box-primary col-xs-12" data-ng-show="profile && !loading">
    <h3>Modify how you see fit!</h3>
    <div class="box box-danger" data-ng-repeat="error in errors">
        @{{ error[0] }}
    </div>
    <form style="display:inline;" data-ng-submit="!submitting && submit('{{csrf_token()}}')">
        ...
        <button type="submit" value="submit" class="btn btn-success btn-flat pull-right" data-ng-class="{'disabled': submitting}">Save</button>
    </form>
</div>
<div class="box box-danger col-xs-12" data-ng-show="!profile && !loading">
