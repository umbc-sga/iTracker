		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				for($i=0; $i<sizeof($groupData); $i++) {
					...
					echo("<h2 id=$groupID>".$groupInfo["name"]."</h2>");
							...
							echo("<div class=\"col-md-4\">
								...
								<div class=\"box box-widget widget-user\">");
									...
									<div class=\"widget-user-header bg-blue\">
										...
										<h5 class=\"widget-user-desc\"><!--<a href=mailto:$email>-->$email<!--</a>--></h5>
									</div>
									<div class=\"box-footer no-padding\">
										<ul class=\"nav nav-stacked\">
											<li><a href=\"#\">Projects <span class=\"pull-right badge bg-blue\">$numActive</span></a></li>
											<li><a href=\"#\">Tasks <span class=\"pull-right badge bg-aqua\">$assignedTasks</span></a></li>
											<li><a href=\"#\">Archived Projects <span class=\"pull-right badge bg-green\">$numArchived</span></a></li>
